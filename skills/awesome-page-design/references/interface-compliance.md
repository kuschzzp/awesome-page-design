...
Use this reference whenever the skill reviews, polishes, or implements real UI code. Visual style is not complete until the interface is usable, accessible, responsive, and state-aware.
...
- Native select, checkbox, radio, and file controls match the selected visual direction when used.

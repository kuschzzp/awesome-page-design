# Version N - Light Skeuomorphism Design System
...
Light Skeuomorphism is a light web UI direction for Apple-like tools, device apps, tactile product UI. Its visual personality is tactile, precise, device-native. Reuse its visual language while designing the actual product structure around user goals, content priority, and workflow requirements.
...
The style language is: Apple gray, embossed surfaces, inset controls, layered physical depth. Preserve the depth model that defines the style. If the style uses square borders, avoid soft cards. If it uses glow or glass, keep contrast and focus visibility intact.
...
Best suited for Apple-like tools, device apps, tactile product UI. Avoid using this style when the brand, audience, or product density conflicts with its personality: tactile, precise, device-native.

## 11. Comparison With Other Styles

Compared with the rest of the library, Light Skeuomorphism is defined by Apple gray, embossed surfaces, inset controls, layered physical depth. It should feel different from generic neutral dashboards while still remaining usable in production.

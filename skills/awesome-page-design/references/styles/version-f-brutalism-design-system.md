# Version F - Neo-Brutalism Design System
...
Neo-Brutalism is a light web UI direction for bold campaigns, indie products, playful utilities. Its visual personality is loud, direct, rebellious. Reuse its visual language while designing the actual product structure around user goals, content priority, and workflow requirements.
...
The style language is: warm yellow, black hard borders, hard shadows, high-saturation labels. Preserve the depth model that defines the style. If the style uses square borders, avoid soft cards. If it uses glow or glass, keep contrast and focus visibility intact.
...
Best suited for bold campaigns, indie products, playful utilities. Avoid using this style when the brand, audience, or product density conflicts with its personality: loud, direct, rebellious.

## 11. Comparison With Other Styles

Compared with the rest of the library, Neo-Brutalism is defined by warm yellow, black hard borders, hard shadows, high-saturation labels. It should feel different from generic neutral dashboards while still remaining usable in production.

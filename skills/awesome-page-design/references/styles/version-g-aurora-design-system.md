# Version G - Aurora Gradient Design System
...
Aurora Gradient is a dark web UI direction for futuristic products, AI tools, premium dark experiences. Its visual personality is premium, energetic, advanced. Reuse its visual language while designing the actual product structure around user goals, content priority, and workflow requirements.
...
The style language is: dark canvas, aurora color fields, soft glow, drifting gradient energy. Preserve the depth model that defines the style. If the style uses square borders, avoid soft cards. If it uses glow or glass, keep contrast and focus visibility intact.
...
Best suited for futuristic products, AI tools, premium dark experiences. Avoid using this style when the brand, audience, or product density conflicts with its personality: premium, energetic, advanced.

## 11. Comparison With Other Styles

Compared with the rest of the library, Aurora Gradient is defined by dark canvas, aurora color fields, soft glow, drifting gradient energy. It should feel different from generic neutral dashboards while still remaining usable in production.

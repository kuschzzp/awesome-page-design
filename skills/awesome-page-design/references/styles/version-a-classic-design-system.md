# Version A - Classic News Design System
...
Classic News is a light web UI direction for editorial sites, authority content, calm product pages. Its visual personality is calm, credible, editorial. Reuse its visual language while designing the actual product structure around user goals, content priority, and workflow requirements.
...
The style language is: light blue-gray canvas, indigo accent, Inter, fine borders, soft shadows. Preserve the depth model that defines the style. If the style uses square borders, avoid soft cards. If it uses glow or glass, keep contrast and focus visibility intact.
...
Best suited for editorial sites, authority content, calm product pages. Avoid using this style when the brand, audience, or product density conflicts with its personality: calm, credible, editorial.

## 11. Comparison With Other Styles

Compared with the rest of the library, Classic News is defined by light blue-gray canvas, indigo accent, Inter, fine borders, soft shadows. It should feel different from generic neutral dashboards while still remaining usable in production.

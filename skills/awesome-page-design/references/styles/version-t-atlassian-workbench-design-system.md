# Version T - Atlassian Workbench Design System
...
Atlassian Workbench is a light web UI direction for collaboration tools, planning apps, team dashboards. Its visual personality is collaborative, clear, work-focused. Reuse its visual language while designing the actual product structure around user goals, content priority, and workflow requirements.
...
The style language is: collaborative blue, lozenge tags, practical workbench surfaces. Preserve the depth model that defines the style. If the style uses square borders, avoid soft cards. If it uses glow or glass, keep contrast and focus visibility intact.
...
Best suited for collaboration tools, planning apps, team dashboards. Avoid using this style when the brand, audience, or product density conflicts with its personality: collaborative, clear, work-focused.

## 11. Comparison With Other Styles

Compared with the rest of the library, Atlassian Workbench is defined by collaborative blue, lozenge tags, practical workbench surfaces. It should feel different from generic neutral dashboards while still remaining usable in production.

...
> 基于 `material-you` 的网站视觉风格提示。参考来源：Material Design 3（https://m3.material.io/）。本文件用于学习和迁移设计语言，不复制任何品牌页面或商标资产。
...
**Material You** 的核心是：动态色彩、圆润容器、层级 Surface 和大号行动按钮。
...
| 次级 Surface | `--surface-2` | `#f3edf7` | 弱背景、按钮、分区 |
| 主文字 | `--text` | `#1d1b20` | 标题和正文 |
| 辅助文字 | `--muted` | `#625b71` | 摘要、时间、说明 |
| 主操作色 | `--accent` | `#6750a4` | 按钮、链接、重点数字 |
| 深强调色 | `--accent-2` | `#7d5260` | hover、深色强调 |
| 分割线 | `--line` | `#e7e0ec` | 边框和分隔 |
| 弱强调背景 | `--soft` | `#eaddff` | 标签、选中态、浅色区域 |

## 3. 排版体系

- 字体栈：`'Roboto', 'Segoe UI', Arial, sans-serif`
...
| 大圆角 | `28px` | Hero、卡片、面板 |
| 小圆角 | `16px` | Logo、标签、按钮 |
| 阴影 | `0 1px 2px rgba(29,27,32,0.08), 0 4px 10px rgba(29,27,32,0.08)` | 主要容器深度 |

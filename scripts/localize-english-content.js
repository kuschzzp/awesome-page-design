...
const styleMeta = [
  ...
  { version: "R", slug: "carbon-enterprise", name: "Carbon Enterprise", mode: "Light", bestFor: "serious enterprise software, analytics, dense operations UI", language: "IBM-like grays, blue action color, square grid, high-density clarity", personality: "serious, systematic, dense" },
  { version: "S", slug: "polaris-commerce", name: "Polaris Commerce", mode: "Light", bestFor: "merchant tools, ecommerce admin, business workflows", language: "warm neutral surfaces, green action tone, resource-list clarity", personality: "merchant-friendly, practical, trustworthy" },
  { version: "T", slug: "atlassian-workbench", name: "Atlassian Workbench", mode: "Light", bestFor: "collaboration tools, planning apps, team dashboards", language: "collaborative blue, lozenge tags, practical workbench surfaces", personality: "collaborative, clear, work-focused" },
  { version: "U", slug: "gov-service", name: "Gov Service", mode: "Light", bestFor: "public service, legal, forms, accessibility-first sites", language: "high contrast, black dividers, blue links, yellow focus states", personality: "official, accessible, direct" },
  { version: "V", slug: "spectrum-creative", name: "Spectrum Creative", mode: "Light", bestFor: "creative software, media tools, asset managers", language: "Adobe-like neutral UI, indigo accent, creative panels and media grids", personality: "creative, tool-like, media-aware" },
  { version: "W", slug: "lightning-crm", name: "Lightning CRM", mode: "Light", bestFor: "CRM, sales tools, customer operations", language: "light app shell, Salesforce-like blue, compact business cards and statuses", personality: "business-ready, compact, operational" },
  { version: "X", slug: "primer-dev", name: "Primer Dev", mode: "Light", bestFor: "developer platforms, docs, repo browsers, issue trackers", language: "GitHub-like borders, blue links, monospace labels, code-oriented sections", personality: "developer-native, structured, repository-like" },
  { version: "Y", slug: "ant-pro", name: "Ant Pro", mode: "Light", bestFor: "enterprise admin, data tables, management consoles", language: "Ant Design blue, thin borders, neutral enterprise surfaces, stable states", personality: "stable, enterprise, table-ready" },
];

# Spectrum Creative 设计系统文档

> 基于 `spectrum-creative` 的网站视觉风格提示。参考来源：Adobe Spectrum（https://spectrum.adobe.com/）。本文件用于学习和迁移设计语言，不复制任何品牌页面或商标资产。
...
**Spectrum Creative** 的核心是：Adobe Spectrum 式创作面板、靛蓝强调、柔和圆角和媒体网格。
...
| 次级 Surface | `--surface-2` | `#f1f1f1` | 弱背景、按钮、分区 |
| 主文字 | `--text` | `#292929` | 标题和正文 |
| 辅助文字 | `--muted` | `#6d6d6d` | 摘要、时间、说明 |
| 主操作色 | `--accent` | `#5258e4` | 按钮、链接、重点数字 |
| 深强调色 | `--accent-2` | `#4046ca` | hover、深色强调 |
| 分割线 | `--line` | `#d8d8d8` | 边框和分隔 |
| 弱强调背景 | `--soft` | `#eeeeff` | 标签、选中态、浅色区域 |

## 3. 排版体系

- 字体栈：`'Adobe Clean', 'Segoe UI', Arial, sans-serif`
...
| 大圆角 | `18px` | Hero、卡片、面板 |
| 小圆角 | `10px` | Logo、标签、按钮 |
| 阴影 | `0 6px 20px rgba(0,0,0,0.08)` | 主要容器深度 |

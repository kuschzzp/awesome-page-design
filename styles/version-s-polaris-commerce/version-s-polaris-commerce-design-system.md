# Polaris Commerce 设计系统文档

> 基于 `polaris-commerce` 的网站视觉风格提示。参考来源：Shopify Polaris（https://polaris.shopify.com/）。本文件用于学习和迁移设计语言，不复制任何品牌页面或商标资产。
...
**Polaris Commerce** 的核心是：商家后台式资源列表、温和绿、清晰卡片和操作优先。
...
| 次级 Surface | `--surface-2` | `#f1f2f3` | 弱背景、按钮、分区 |
| 主文字 | `--text` | `#202223` | 标题和正文 |
| 辅助文字 | `--muted` | `#6d7175` | 摘要、时间、说明 |
| 主操作色 | `--accent` | `#008060` | 按钮、链接、重点数字 |
| 深强调色 | `--accent-2` | `#005e46` | hover、深色强调 |
| 分割线 | `--line` | `#d2d5d8` | 边框和分隔 |
| 弱强调背景 | `--soft` | `#e3f1df` | 标签、选中态、浅色区域 |

## 3. 排版体系

- 字体栈：`-apple-system, BlinkMacSystemFont, 'San Francisco', 'Segoe UI', sans-serif`
...
| 大圆角 | `12px` | Hero、卡片、面板 |
| 小圆角 | `8px` | Logo、标签、按钮 |
| 阴影 | `0 1px 0 rgba(0,0,0,0.05), 0 3px 10px rgba(0,0,0,0.06)` | 主要容器深度 |
